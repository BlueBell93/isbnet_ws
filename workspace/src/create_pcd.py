...
def main():
    ...
    # gehe über alle Dateien -> vllcht vorher Liste über alle Dateien erstellen und erstelle/speichere die Ergebnisse ab
    ...
    # Liste über alle Dateien/Ordner in pred_instance
    # Ohne Dateiendung
